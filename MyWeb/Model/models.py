...
class StudentTable(models.Model):
    ...
    English_class = models.CharField(max_length=2)  # 英语等级
    college = models.ForeignKey(CollegeTable, on_delete=models.CASCADE)  # 院系号
...
class OpenTable(models.Model):  # 开课表
    ...
    teacher = models.ForeignKey(TeacherTable, on_delete=models.CASCADE)  # 工号
...
class ScoreTable(models.Model):  # 选课表
    student = models.ForeignKey(StudentTable, on_delete=models.CASCADE)  # 学号
    open = models.ForeignKey(OpenTable, on_delete=models.CASCADE)  # 开课标识号
