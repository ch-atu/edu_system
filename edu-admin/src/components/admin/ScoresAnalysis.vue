<template>
  <div>
    ...
    <el-card class="card_box">
      <div id="chart_dificulty" style="width: 100%; height: 550px"></div>
    </el-card>
    <el-card class="card_box">
      <div id="chart_distribution" style="width: 100%; height: 550px"></div>
    </el-card>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      if (res.status !== 200) return this.$message.error('未查询到任何数据！')
      console.log(res)
