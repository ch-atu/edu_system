  ...
  <div>
    ...
    <el-card>
      ...
      <div id="printMe" ref="printContent">
        ...
        <el-table :data="studentlistShow" border stripe :cell-style="cellStyle">
...
export default {
  ...
  methods: {
    async getstudent() {
      ...
      console.log('获取的studentlistShow：', this.studentlistShow)
    ...
    addScore() {
      this.$refs.addFormRef.validate(async (valid) => {
        ...
        const { data: res } = await this.$http.put(
          `teacher/score/edit/?student=${this.addForm.user_id}&course_id=${this.addForm.course_id}`,
          {
